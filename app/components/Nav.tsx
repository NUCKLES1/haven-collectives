...
export const Nav = () => {
  ...
  return (
    <div className="lg:px-16 px-6 w-full h-20 py-4 pt-10 lg:pt-6 fixed z-100 max-sm:bg-white">
      <div className="w-full flex justify-between">
        <span className="font-semibold max-sm:text-black text-xl">
          HHC
        </span>
        ...
        <div className="flex justify-between gap-10">
          ...
          <div className="max-sm:hidden">
            <CgShoppingCart className="text-black text-xl"/>
          ...
          <div className="max-sm:hidden">
            <User2 className="text-black text-xl"/>
            <div className="hidden">
              <p>
                <span>0</span> items
              </p>
